...
print("Clearing space in files.")

#if len(os.listdir(output_path)) != 0:
#    filelist = [ f for f in os.listdir(output_path)]
#    for f in filelist:
#        os.remove(os.path.join(output_path, f))
#if len(os.listdir(temp_files_path)) != 0:
#    filelist = [ f for f in os.listdir(temp_files_path)]
#    for f in filelist:
#        os.remove(os.path.join(temp_files_path, f))
        
print("Directories cleared.",(time.time() - start_time), "seconds elapsed.")
